      ...
      <div className="flex flex-wrap items-center gap-3">
        ...
        <div className="relative flex-1 sm:flex-initial">
          ...
          <select
            ...
            className="w-full sm:w-auto pl-9 pr-8 py-2.5 bg-slate-50 border border-slate-200 rounded-xl text-slate-900 text-xs font-medium capitalize focus:outline-none focus:ring-2 focus:ring-indigo-600 appearance-none cursor-pointer disabled:opacity-50"
          >
        ...
        <div className="relative flex-1 sm:flex-initial">
          ...
          <select
            ...
            className="w-full sm:w-auto pl-9 pr-8 py-2.5 bg-slate-50 border border-slate-200 rounded-xl text-slate-900 text-xs font-medium focus:outline-none focus:ring-2 focus:ring-indigo-600 appearance-none cursor-pointer"
          >
        ...
        {hasActiveFilters && (
          <button
            onClick={onReset}
            className="px-3 py-2.5 text-xs font-medium text-slate-600 hover:text-slate-900 bg-slate-100 hover:bg-slate-200 rounded-xl inline-flex items-center gap-1.5 transition-colors"
